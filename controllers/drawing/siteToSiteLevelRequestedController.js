...
exports.rejectRequest = catchAsync(async (req, res, next) => {
  ...
  const updatedRegister = await ArchitectureToRoRegister.findOneAndUpdate(
    ...
    {
      $set: {
        "acceptedSiteHeadRevisions.$[elem].rfiStatus": "Not Raised",
        "acceptedSiteHeadRevisions.$[elem].rfiRejectStatus": "Rejected",
        "acceptedArchitectRevisions.$[arch].siteLevelRfiStatus": "Not Raised",

        // ✅ ADDED — only date field
        "acceptedSiteHeadRevisions.$[elem].rfiRespondedDate": Date.now(),
        "acceptedArchitectRevisions.$[arch].rfiRespondedDate": Date.now(),
      },
    },
    {
      new: true,
