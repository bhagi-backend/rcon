...
const ArchitecturePendingRegistersSchema = new Schema({
...
const ArchitecturePendingRegisters = mongoose.model('ArchitecturePendingRegisters', ArchitecturePendingRegistersSchema);

module.exports = ArchitecturePendingRegisters;
