...
router.get("/site", authController.protect,ArchitectureToRoRequestedController.getAllRequestsBySiteId);
router.get("/architect", authController.protect,ArchitectureToRoRequestedController.getAllRequestsBySiteIdForArchitect);
router.get("/request/:id",authController.protect, ArchitectureToRoRequestedController.getRequestBeforeUpdateRevision);
router.get("/byDrawingId",authController.protect, ArchitectureToRoRequestedController.getRequestByDrawingId);
router.get("/pdfbyDrawingId",authController.protect, ArchitectureToRoRequestedController.generatePdfReport);
router.get("/", ArchitectureToRoRequestedController.getAllRequests);
router.get("/:id", authController.protect,ArchitectureToRoRequestedController.getRequest);
router.get("/view/:id",authController.protect, ArchitectureToRoRequestedController.getViewRequest);
router.get("/viewRejectDwg/:id",authController.protect, ArchitectureToRoRequestedController.getViewRejectDwgFile);
...
router.put("/reject/:id",authController.protect,ArchitectureToRoRequestedController.rejectRequest);
router.put(
  "/rejectFile/:id",
  authController.protect,
  ArchitectureToRoRequestedController.uploadRejectedFile,
  ArchitectureToRoRequestedController.updateRejectedFile);
router.get("/rejectFile/:id",authController.protect, ArchitectureToRoRequestedController.getRejectedFile);
router.put("/accept/:id",authController.protect,ArchitectureToRoRequestedController.acceptRequest);
router.put("/closed/:id",authController.protect,ArchitectureToRoRequestedController.closeRequest);
router.put("/reOpen/:id",authController.protect,ArchitectureToRoRequestedController.reopenRequest);
router.put(
  "/impactImages/:id",
  authController.protect,
